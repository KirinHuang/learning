...
/* harmony import */ var _heros_heros_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./heros/heros.component */ "./src/app/heros/heros.component.ts");
...
var routes = [
    ...
    { path: 'heroes', component: _heros_heros_component__WEBPACK_IMPORTED_MODULE_2__["HerosComponent"] },
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _heros_heros_component__WEBPACK_IMPORTED_MODULE_5__["HerosComponent"],
...
module.exports = "<h3>Top Heroes</h3>\n<div class=\"grid grid-pad\">\n  <a *ngFor=\"let hero of heros\" class=\"col-1-4\" routerLink=\"/detail/{{hero.id}}\">\n    <div class=\"module hero\">\n      <h4>{{hero.name}}</h4>\n    </div>\n  </a>\n</div>\n"
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(hereService) {
    ...
    DashboardComponent.prototype.getHeros = function () {
        var _this = this;
        this.hereService.getHeros().subscribe(function (heros) { return _this.heros = heros.slice(1, 5); });
    };
...
/* harmony import */ var _mock_heros__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mock-heros */ "./src/app/mock-heros.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HeroService = /** @class */ (function () {
    ...
    HeroService.prototype.getHero = function (id) {
        this.messageService.add("HelloService: fetch hero by id=" + id);
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(_mock_heros__WEBPACK_IMPORTED_MODULE_3__["HEROS"].find(function (hero) { return hero.id === id; }));
    };
    HeroService.prototype.getHeros = function () {
        this.messageService.add('HelloService: fetch heros');
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(_mock_heros__WEBPACK_IMPORTED_MODULE_3__["HEROS"]);
    };
...
var HerosComponent = /** @class */ (function () {
    ...
    HerosComponent.prototype.getHeros = function () {
        var _this = this;
        this.heroService.getHeros().subscribe(function (heres) { return _this.heros = heres; });
    };
...
/*!*******************************!*\
  !*** ./src/app/mock-heros.ts ***!
  \*******************************/
/*! exports provided: HEROS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HEROS", function() { return HEROS; });
var HEROS = [
    { id: 11, name: 'Mr. Nice' },
    { id: 12, name: 'Narco' },
    { id: 13, name: 'Bombasto' },
...
module.exports = __webpack_require__(/*! /Users/robinwee/angulardemo/src/main.ts */"./src/main.ts");
